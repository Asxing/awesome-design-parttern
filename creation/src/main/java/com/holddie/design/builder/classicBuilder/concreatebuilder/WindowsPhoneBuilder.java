package com.holddie.design.builder.classicBuilder.concreatebuilder;


import com.holddie.design.builder.classicBuilder.builder.IMobilePhoneBuilder;
import com.holddie.design.builder.classicBuilder.product.MobilePhone;
import com.holddie.design.builder.classicBuilder.product.enumEntity.BatteryType;
import com.holddie.design.builder.classicBuilder.product.enumEntity.OperationSystemType;
import com.holddie.design.builder.classicBuilder.product.enumEntity.ScreenType;
import com.holddie.design.builder.classicBuilder.product.enumEntity.StylusType;
